...
Belt_Result.getExn(Belt_Result.flatMap(Belt_Result.flatMap(Belt_Result.map(Belt_Result.flatMap(Belt_Result.flatMap(Belt_Result.flatMap(Belt_Result.flatMap(Belt_Result.flatMap({
                                      TAG: /* Ok */0,
                                      _0: undefined
                                    }, (function (param) {
                                        return Curry._1(TestJsonRecordEventGateway.createTableIfNotExist, undefined);
                                      })), (function (param) {
                                    return Curry._1(TestJsonRecordEventGateway.insertEvent, "event1");
                                  })), (function (param) {
                                return Curry._1(TestJsonRecordEventGateway.insertEvent, "event2");
                              })), (function (param) {
                            return Curry._1(TestJsonRecordEventGateway.insertEvent, "event1");
                          })), (function (param) {
                        return Belt_Result.map(Curry._3(TestJsonRecordEventGateway.getEvents, 0, undefined, undefined), (function (prim) {
                                      console.log(prim);
                                    }));
                      })), (function (param) {
                    console.log("---");
                  })), (function (param) {
                return Belt_Result.map(Curry._3(TestJsonRecordEventGateway.getEvents, 1, 1, undefined), (function (prim) {
                              console.log(prim);
                            }));
              })), (function (param) {
